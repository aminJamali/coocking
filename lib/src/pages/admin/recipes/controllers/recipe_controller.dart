...
void addToLocalList(
    {required final RecipeViewModel recipeViewModel}) =>
    paginationList.key.currentState!
        .addItem(recipeViewModel, atIndex: 0);
...
Future<void> deleteIngredient(final int recipeId) async {
  deleteLoading.value = true;
  final Either<String, String> response = await _recipeRepository
